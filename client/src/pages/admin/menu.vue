    ...
    <v-dialog v-model="dialog" max-width="550">
        <v-card>
            ...
            <v-card-text>
                <v-row>
                    <v-col cols="12">
                        <v-avatar v-ripple size="150" class="cursor-pointer" @click="handleAddImage">
...
import { get_foods, create_food, update_food, delete_food } from '../../api/food'
...
const add = async (body) => {
    const { data } = await create_food(body)
